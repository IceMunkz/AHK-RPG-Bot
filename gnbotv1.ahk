...
if FindClick("C:\GN\bust2.png","o20", "n")    ;Anti-Script for Jailwait periods - need to update to be more in line with randomised times. Acts as a wrapper
	{ sleep 12000
	GUIcontrol , , StatusText, % "JAILDETECTOR - YOU ARE JAILED BOT WILL PAUSE"
	} else {
